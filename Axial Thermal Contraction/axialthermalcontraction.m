...
filename ='Thermal Contraction Vibrometer Data Feb_11_18.csv';
num = csvread(filename);

timevib = num(1:end,1);
Disp = num(1:end,2);
filename ='thermalcontractioncamera.txt';
...
fig2 = figure('color','w');
 plot(f,T_set_to_zero,Strain); hold on
...
% ExcelData = [newtempcam Strain]
% filename1 = 'thermalaxialcontractiondata.xlsx'
