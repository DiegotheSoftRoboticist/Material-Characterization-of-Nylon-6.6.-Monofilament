...
filename ='Thermal Contraction Vibrometer Data Feb_17_secondtest.csv';
num = csvread(filename);

timevib = num(1:end,1);
Disp = num(1:end,2);
filename ='Axial Contraction Temporal Plot Feb_17_18 (2).txt';
...
ExcelData = [newtempcam(1:2565) Strain(1:2565)]
filename1 = 'CleanDataSecondTest1.xlsx'
