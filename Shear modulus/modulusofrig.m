...
torque_amb = num_amb(1:end,2)*0.001;
torque_45 = num_45(1:end,2)*0.001;
torque_65 = num_65(1:end,2)*0.001;
torque_85 = num_85(1:end,2)*0.001;
torque_105 = num_45(1:end,2)*0.001;

rad_amb = num_amb(1:end,1);
rad_45 = num_45(1:end,1);
rad_65 = num_65(1:end,1);
rad_85 = num_85(1:end,1);
rad_105 = num_105(1:end,1);

Axial_amb = num_amb(1:end,3);
Axial_45 = num_45(1:end,3);
Axial_65 = num_65(1:end,3);
Axial_85 = num_85(1:end,3);
Axial_105 = num_105(1:end,3);
...
fig1a=figure; hold on; grid on; set(gca,'FontSize',20);

  Gamma_amb = (0.89*rad_amb/20);
Shear_amb = 0.89*torque_amb/J*2;
pGamma_amb = polyfit(Gamma_amb,Shear_amb,1);
fitGamma_amb = polyval(pGamma_amb,Gamma_amb);   


p1 = plot(Gamma_amb,Shear_amb,'Color',[0.6350, 0.0780, 0.1840],'LineWidth',2); hold on
plot(Gamma_amb,fitGamma_amb,'k','LineWidth', 0.8)
   
xlabel('$\gamma_{12}$ (rad)')
ylabel('$\tau_{12}$ (MPa)')       
       
fig1b=figure; hold on; grid on; set(gca,'FontSize',20);



pTl_thetaJ_amb = polyfit(G_amb_den,G_amb_num,1);
fitTl_thetaJ_amb = polyval(pTl_thetaJ_amb,G_amb_den);


p1 = plot(G_amb_den,G_amb_num,'Color',[0.6350, 0.0780, 0.1840],'LineWidth',2); hold on
plot(G_amb_den,fitTl_thetaJ_amb,'k','LineWidth', 0.8)
...
% 
% 
% plot(rad_amb,torque_amb,'Color',[0.6350, 0.0780, 0.1840],'LineWidth',2); hold on
% plot(rad_amb,fit_amb,'k','LineWidth', 0.8)
% 
% xlabel('Angular Displacement (rad)')
% ylabel('Torque (N mm)')
% legend('Experimental results at $$(25^{\circ}C)$$','Linear fit with a slope of 496 $$(N mm/^{\circ})$$ ','Location','Northwest')
% grid on 
% saveas(fig2,'ElasticAxialM_subplots1','tif')
% 
% fig3=figure; hold on; grid on; set(gca,'FontSize',14);
% 
% plot(rad_45,torque_45,'Color',[0.4660, 0.6740, 0.1880],'LineWidth',2); hold on
% plot(rad_45,fit_45,'k','LineWidth', 0.8)
% xlabel('Angular Displacement (rad)')
% ylabel('Torque (N mm)')
% legend('Experimental results at $$(45^{\circ}C)$$','Linear fit with a slope of 310 $$(N mm/^{\circ})$$','Location','Northwest')
% grid on 
% saveas(fig3,'ElasticAxialM_subplots2','tif')
% 
% fig4=figure; hold on; grid on; set(gca,'FontSize',14);
% 
% plot(rad_65,torque_65,'Color',[0, 0.4470, 0.7410],'LineWidth',2); hold on
% plot(rad_65,fit_65,'k','LineWidth', 0.8)
% xlabel('Angular Displacement (rad)')
% ylabel('Torque (N mm)')
% legend('Experimental results at $$(65^{\circ}C)$$','Linear fit with a slope of 177 $$(N mm/^{\circ})$$','Location','Northwest')
% grid on 
% saveas(fig4,'ElasticAxialM_subplots3','tif')
% 
% fig5=figure; hold on; grid on; set(gca,'FontSize',14);
% 
% plot(rad_85,torque_85,'Color',[0.8500, 0.3250, 0.0980],'LineWidth',2); hold on
% plot(rad_85,fit_85,'k','LineWidth', 0.8)
% xlabel('Angular Displacement (rad)')
% ylabel('Torque (N mm)')
% legend('Experimental results at $$(85^{\circ}C)$$','Linear fit with a slope of 125 $$(N mm/^{\circ})$$','Location','Northwest')
% grid on 
% saveas(fig5,'ElasticAxialM_subplots4','tif')
% 
% fig6=figure; hold on; grid on; set(gca,'FontSize',14);
% 
% plot(rad_105,torque_105,'Color',[0.9, 0.9, 0.25],'LineWidth',2); hold on
% plot(rad_105,fit_105,'k','LineWidth', 0.8)
% xlabel('Angular Displacement (rad)')
% ylabel('Torque (N mm)')
% legend('Experimental results at $$(105^{\circ}C)$$','Linear fit with a slope of 109 $$(N mm/^{\circ})$$','Location','Northwest')
% grid on 
% 
% saveas(fig6,'ElasticAxialM_subplots5','tif')

% fig7=figure; hold on; grid on; set(gca,'FontSize',14);

%  E_temp = [3.80026,1.8617,0.85695,0.60709,0.50403]
%  temp_E = [25,45,65,85,105]
%  plot(temp_E,E_temp,'k','LineWidth', 1); hold on
